...
2. **Level check** (R-LVL-06):
   ...
   2. **Rater 1** (a fresh subagent) rates **every** token, plus the grammar structures in target-language text, with a CEFR level. It sees only the tokens, their fields, and the level scale.
