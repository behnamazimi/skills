...
4. Pronunciation exactly as `spec.pronunciation` says (R-PRON). Immersion: nothing in any other language (R-IMM).
5. Leave out unused optional fields entirely. Set `id` and `batch` on every entry.
